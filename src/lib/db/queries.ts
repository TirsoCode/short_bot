...
function toSettings(r: SettingsRow) { return { ...r, githubOwner: r.github_owner, githubRepo: r.github_repo, githubBranch: r.github_branch, githubPaths: parseJsonField(r.github_paths), githubToken: r.github_token, youtubeClientId: r.youtube_client_id, youtubeClientSecret: r.youtube_client_secret, youtubeRefreshToken: r.youtube_refresh_token, syncIntervalMinutes: r.sync_interval_minutes, maxShortDuration: r.max_short_duration, videoWidth: r.video_width, videoHeight: r.video_height, videoFps: r.video_fps, mediaPaths: parseJsonField(r.media_paths, ['videos', 'fotos']) }; }
